namespace ShadowNote_CS
{
	partial class LogAna
	{
		...
		private void InitializeComponent()
		{
			...
			this.comboBox_Myclass = new System.Windows.Forms.ComboBox();
			this.checkBox_Mydec = new System.Windows.Forms.CheckBox();
			this.checkBox_Myclass = new System.Windows.Forms.CheckBox();
			this.button_Ana = new System.Windows.Forms.Button();
			this.tabPage3 = new System.Windows.Forms.TabPage();
			this.dataGridView_Deck = new System.Windows.Forms.DataGridView();
			...
			// button1
			// 
			this.button1.Location = new System.Drawing.Point(1079, 354);
			...
			this.comboBox_Mydec.Location = new System.Drawing.Point(31, 92);
			...
			this.label3.Text = "自クラス";
			// 
			// comboBox_Myclass
			// 
			this.comboBox_Myclass.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.comboBox_Myclass.FormattingEnabled = true;
			this.comboBox_Myclass.Location = new System.Drawing.Point(31, 149);
			this.comboBox_Myclass.Name = "comboBox_Myclass";
			this.comboBox_Myclass.Size = new System.Drawing.Size(121, 20);
			this.comboBox_Myclass.TabIndex = 7;
			// 
			// checkBox_Mydec
			// 
			this.checkBox_Mydec.AutoSize = true;
			this.checkBox_Mydec.Location = new System.Drawing.Point(10, 95);
			...
			// checkBox_Myclass
			// 
			this.checkBox_Myclass.AutoSize = true;
			this.checkBox_Myclass.Location = new System.Drawing.Point(10, 149);
			this.checkBox_Myclass.Name = "checkBox_Myclass";
			this.checkBox_Myclass.Size = new System.Drawing.Size(15, 14);
			this.checkBox_Myclass.TabIndex = 11;
			this.checkBox_Myclass.UseVisualStyleBackColor = true;
			// 
			// button_Ana
			// 
			...
			// tabPage3
			// 
			this.tabPage3.Controls.Add(this.dataGridView_Deck);
			this.tabPage3.Location = new System.Drawing.Point(4, 22);
			this.tabPage3.Name = "tabPage3";
			this.tabPage3.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage3.Size = new System.Drawing.Size(907, 453);
			...
			// dataGridView_Deck
			// 
			this.dataGridView_Deck.AllowUserToAddRows = false;
			this.dataGridView_Deck.AllowUserToDeleteRows = false;
			this.dataGridView_Deck.AllowUserToResizeColumns = false;
			this.dataGridView_Deck.AllowUserToResizeRows = false;
			this.dataGridView_Deck.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dataGridView_Deck.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
			...
			this.dataGridView_Deck.Location = new System.Drawing.Point(0, 0);
			this.dataGridView_Deck.Name = "dataGridView_Deck";
			this.dataGridView_Deck.RowHeadersVisible = false;
			this.dataGridView_Deck.RowTemplate.Height = 21;
			this.dataGridView_Deck.Size = new System.Drawing.Size(901, 450);
			this.dataGridView_Deck.TabIndex = 15;
			// 
			...
			this.dataGridViewTextBoxColumn14.HeaderText = "先攻勝数";
			...
			this.dataGridViewTextBoxColumn15.HeaderText = "先攻敗数";
			...
			this.dataGridViewTextBoxColumn16.HeaderText = "先攻勝率(%)";
			...
			this.dataGridViewTextBoxColumn17.HeaderText = "後攻勝数";
			...
			this.dataGridViewTextBoxColumn18.HeaderText = "後攻敗数";
			...
			this.dataGridViewTextBoxColumn19.HeaderText = "後攻勝率(%)";
			...
			this.dataGridViewTextBoxColumn20.HeaderText = "勝数計";
			...
			this.dataGridViewTextBoxColumn21.HeaderText = "敗数計";
			...
			this.dataGridViewTextBoxColumn22.HeaderText = "勝率(%)";
			this.dataGridViewTextBoxColumn22.Name = "dataGridViewTextBoxColumn22";
			this.dataGridViewTextBoxColumn22.ReadOnly = true;
			this.dataGridViewTextBoxColumn22.Width = 68;
			// 
			// tabPage2
			// 
			...
			this.tabPage2.Size = new System.Drawing.Size(907, 453);
			...
			this.dataGridView_Rank.Size = new System.Drawing.Size(790, 450);
			...
			this.tabPage1.Size = new System.Drawing.Size(907, 453);
			...
			this.comboBox_Time.Location = new System.Drawing.Point(31, 255);
			this.comboBox_Time.Name = "comboBox_Time";
			this.comboBox_Time.Size = new System.Drawing.Size(121, 20);
			this.comboBox_Time.TabIndex = 14;
			// 
			// checkBox_Eneclass
			// 
			this.checkBox_Eneclass.AutoSize = true;
			this.checkBox_Eneclass.Location = new System.Drawing.Point(10, 202);
			this.checkBox_Eneclass.Name = "checkBox_Eneclass";
			this.checkBox_Eneclass.Size = new System.Drawing.Size(15, 14);
			this.checkBox_Eneclass.TabIndex = 19;
			...
			this.comboBox_Eneclass.Location = new System.Drawing.Point(31, 199);
			this.comboBox_Eneclass.Name = "comboBox_Eneclass";
			this.comboBox_Eneclass.Size = new System.Drawing.Size(121, 20);
			this.comboBox_Eneclass.TabIndex = 17;
			// 
			// checkBox_TimeDesign
			// 
			this.checkBox_TimeDesign.AutoSize = true;
			this.checkBox_TimeDesign.Location = new System.Drawing.Point(10, 311);
			this.checkBox_TimeDesign.Name = "checkBox_TimeDesign";
			this.checkBox_TimeDesign.Size = new System.Drawing.Size(15, 14);
			this.checkBox_TimeDesign.TabIndex = 21;
			this.checkBox_TimeDesign.UseVisualStyleBackColor = true;
			// 
			// label5
			// 
			...
			this.Controls.Add(this.checkBox_Myclass);
			this.Controls.Add(this.checkBox_Mydec);
			this.Controls.Add(this.label3);
			this.Controls.Add(this.comboBox_Myclass);
			...
			((System.ComponentModel.ISupportInitialize)(this.dataGridView_Deck)).EndInit();
		...
		private System.Windows.Forms.ComboBox comboBox_Myclass;
		private System.Windows.Forms.CheckBox checkBox_Mydec;
		private System.Windows.Forms.CheckBox checkBox_Myclass;
		private System.Windows.Forms.Button button_Ana;
		private System.Windows.Forms.TabPage tabPage3;
		private System.Windows.Forms.DataGridView dataGridView_Deck;
